            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-9">
                    <section class="footer-item">
                        <a href="index-2.html" class="logo footer-logo"><img src="{{asset('client/assets/images/lucky-star-logo.png')}}" alt="biolife logo" width="135" height="34"></a>
                        <div class="footer-phone-info">
                            <i class="biolife-icon icon-head-phone"></i>
                            <p class="r-info">
                                <span>Got Questions ?</span>
                                <span>(+63) 995 325 1120</span>
                            </p>
                        </div>
                            ...
                            <ul class="contact-lines">
                                <li>
                                    <p class="info-item">
                                        ...
                                        <b class="desc">4114 Dasmariñas, Cavite, Philippines </b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="biolife-icon icon-phone"></i>
                                        <b class="desc">Phone: (+63) 995 325 1120</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="biolife-icon icon-letter"></i>
                                        <b class="desc">Email:  support@luckystar.com</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
    ...
    <div class="block-global-contain">
        ...
        <div class="glb-item languages">
            ...
            <ul class="list inline">
                <li class="list-item"><a href="#"><img src="{{asset('client/assets/images/languages/us.jpg')}}" alt="flag" width="24" height="18"></a></li>
                <li class="list-item"><a href="#"><img src="{{asset('client/assets/images/languages/fr.jpg')}}" alt="flag" width="24" height="18"></a></li>
                <li class="list-item"><a href="#"><img src="{{asset('client/assets/images/languages/ger.jpg')}}" alt="flag" width="24" height="18"></a></li>
                <li class="list-item"><a href="#"><img src="{{asset('client/assets/images/languages/jap.jpg')}}" alt="flag" width="24" height="18"></a></li>
            </ul>
        </div>
    </div>
</div>
