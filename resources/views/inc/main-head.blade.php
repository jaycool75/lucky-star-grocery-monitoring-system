...
<title>{{config('app.name', 'Lucky Star Grocery')}}</title>
...
<link rel="stylesheet" type="text/css" href="{{asset('client/assets/css/animate.min.css')}}">
...
<link rel="stylesheet" type="text/css" href="{{asset('client/assets/css/main-color02.css')}}">